...
namespace Eventos.IO.Domain.Eventos
{
    public class Evento : Entity<Evento>
    {
        ...
        public void AtribuiEndereco (Endereco endereco)
        {
            if (!endereco.EhValido()) return;
            Endereco = endereco;
        }

        public void AtribuiCategoria (Categoria categoria)
        {
        ...
        #region Validações
        //Validações do domínio - Utilizando o FluentValidation
        ...
        private void ValidarNome()
        {
            RuleFor(c => c.Nome)
                ...
                .Length(3, 150).WithMessage("O nome do evento precisa ter entre 3 e 150 caracteres");
        }
        ...
        private void ValidarValor()
        {
            ...
            if (Gratuito)
                RuleFor(c => c.Valor)
                    .InclusiveBetween(0, 0).When(c => c.Gratuito)
        ...
        private void ValidarData()
        {
            RuleFor(c => c.DataInicio)
                ...
                .WithMessage("A data de início deve ser menor que a data final do evento");
        ...
        private void ValidarLocal()
        {
            if (Online)
                RuleFor(c => c.Endereco)
                    ...
                    .WithMessage("O evento não pode possuir endereço se for online");
        ...
        private void ValidarNomeEmpresa() {
            {
                RuleFor(c => c.NomeEmpresa)
                    .NotEmpty().WithMessage("O nome do organizador precisa ser forncedo")
        ...
        {
            public static Evento NovoEventoCopleto(Guid id, string nome, string descCurta, string descLonga, DateTime dataInicio, DateTime dataFim,
