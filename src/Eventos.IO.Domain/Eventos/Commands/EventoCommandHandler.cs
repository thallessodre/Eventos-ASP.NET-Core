...
namespace Eventos.IO.Domain.Eventos.Commands
{
        ...
        IHandler<AtualizarEnderecoEventoCommand>
    {
        ...
        public void Handle(RegistrarEventoCommand message)
        {
            ...
            var evento = Evento.EventoFactory.NovoEventoCopleto(message.Id, message.Nome, message.DescricaoCurta, message.DescricaoLonga, message.DataInicio, message.DataFim,
        ...
        public void Handle(AtualizarEventoCommand message)
        {
            ...
            {
                _bus.RaiseEvent(new DomainNotification(message.MessageType, "Evento não pertece ao organizador"));
                return;
            }
